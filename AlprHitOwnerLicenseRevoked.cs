...
{
    [CalloutProperties("ALPR Hit (Owner License Revoked)", "Darihon", "1.0")]
    public class AlprHitOwnerLicenseRevoked : Callout
    {
        ...
        public AlprHitOwnerLicenseRevoked()
        {
            InitInfo(World.GetNextPositionOnStreet(
                Game.PlayerPed.GetOffsetPosition(Utils.GetRandomPosition(300, 800))));
            ShortName = "ALPR Hit (Owner License Revoked)";
            CalloutDescription = "We have received an ALPR hit on a vehicle. Vehicle owner has a revoked license.";
            ResponseCode = 2;
            StartDistance = 150f;
        }
        ...
        public override async void OnStart(Ped player)
        {
            ...
            this.SuspectData.DriverLicense.LicenseStatus = PedData.License.Status.Revoked;
